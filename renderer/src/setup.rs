...
use crate::graphics::Body;

#[allow(unused)]
pub fn setup_points(screen: &mut Screen) {
    let body_one = Body {
        pos: Pos {
            x: 5.0,
            y: 5.0,
...
#[allow(unused)]
pub fn setup_spherical_points(screen: &mut Screen) {
...
#[allow(unused)]
pub fn setup_world_points(screen: &mut Screen) {
    let center_x = 0.0;
    let center_y = 0.0;
    let center_z = 10.0;
    let r = 4.0;
